...
def load_json_to_mongodb(json_folder, db_name, collection_name, mongo_uri="mongodb://localhost:27017/"):
    ...
    old_data_folder = os.path.join(json_folder, "OldDataCredit")
    ...
    for file_name in os.listdir(json_folder):
        if file_name.endswith('.json'):
            ...
            try:
                ...
                print(f"Archivo {file_name} procesado y movido a OldDataCredit.")
...
if __name__ == "__main__":
    ...
    load_json_to_mongodb(json_folder, db_name, collection_name, mongo_uri)
